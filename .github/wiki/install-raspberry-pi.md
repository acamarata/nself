...
Install the nSelf CLI on Raspberry Pi (armv7 32-bit or arm64 64-bit). Tested on Raspberry Pi 4B and Pi 5.
...
## Step 2: Download the nSelf CLI Binary
...
**Memory limits:** A full nSelf stack (Postgres + Hasura + Auth + Nginx) uses approximately 600-900 MB RAM at idle. A Pi 4B 2GB can run the stack but leaves little headroom. Recommended: 4GB or 8GB model.
