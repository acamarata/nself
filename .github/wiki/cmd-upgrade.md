...
|------|---------|-------------|
| `--binary-sha256` | `""` | Operator-supplied SHA-256 digest for --binary-url (skips checksums.txt fetch) |
| `--binary-url` | `""` | Install from a specific binary URL (HTTPS only; .tar.gz/.tgz; operator use) |
