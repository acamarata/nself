...
Always maintain minimum clearspace around the logo equal to **the height of the ɳ mark** on all sides. Do not place other elements within this clearspace.

```
┌─────────────────────┐
│    [clearspace]     │
│  [clearspace] ɳSelf [clearspace]  │
│    [clearspace]     │
└─────────────────────┘
```
