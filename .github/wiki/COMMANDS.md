...
nSelf CLI provides 46 top-level commands. Each command links to a dedicated page with full usage, flags, and examples.
...
| [[cmd-start]] | Boot the nSelf stack with health checks and automatic database initialization (alias: `up`) |
...
| [[cmd-claw]] | Manage nClaw AI assistant |
...
| [[cmd-upgrade]] | Upgrade the nSelf CLI (detects install method) |
