...
| Light grey | `#E5E7EB` | Secondary text, borders |
| Mid grey | `#6B7280` | Muted text, placeholders |
| Success green | `#22C55E` | Healthy status, success states |
| Warning amber | `#F59E0B` | Warning states |
| Error red | `#EF4444` | Error states, critical alerts |

## Usage Notes

- Always use Indigo (`#6366F1`) as the primary action colour
- Use the dark background (`#0F0F1A`) for main app surfaces
- Ensure text contrast meets WCAG AA (4.5:1 minimum ratio)
