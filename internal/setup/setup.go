...
func Initialize(opts Options) (*Result, error) {
	...
	hasuraAdminSecret := GenerateSecret(44)
	hasuraJWTKey := GenerateSecret(44)
	...
	notifySecret := GenerateSecret(32)
	cronSecret := GenerateSecret(32)
	pluginInternalSecret := GenerateSecret(32)

	// Build .env content.
	var envContent string
	if opts.Demo {
		envContent = buildDemoEnv(projectName, baseDomain, env, postgresPassword, hasuraAdminSecret, hasuraJWTKey, minioPassword, notifySecret, cronSecret, pluginInternalSecret, opts.DomainComment)
	} else {
		envContent = buildStandardEnv(projectName, baseDomain, env, postgresPassword, hasuraAdminSecret, hasuraJWTKey, notifySecret, cronSecret, pluginInternalSecret, opts.DomainComment)
	}
...
func buildStandardEnv(projectName, baseDomain, env, pgPass, hasuraSecret, jwtKey, notifySecret, cronSecret, pluginInternalSecret, domainComment string) string {
	return fmt.Sprintf(`# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
`, projectName, buildDomainLine(baseDomain, domainComment), env, projectName, pgPass, hasuraSecret, jwtKey, notifySecret, cronSecret, pluginInternalSecret)
}

// buildDemoEnv generates .env for --demo mode with all services enabled.
func buildDemoEnv(projectName, baseDomain, env, pgPass, hasuraSecret, jwtKey, minioPassword, notifySecret, cronSecret, pluginInternalSecret, domainComment string) string {
	return fmt.Sprintf(`# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
HASURA_GRAPHQL_ADMIN_SECRET=%s
HASURA_JWT_KEY=%s
`, GenerateSecret(32), GenerateSecret(44), GenerateSecret(44))
