...
// NginxConf returns the nginx configuration fragment for /api-docs and /docs.
// path is the docs serve path (default /docs).
func NginxConf(docsServePath string) string {
	if docsServePath == "" {
		docsServePath = "/docs"
	}
	return fmt.Sprintf(`# api-docs.conf — generated by nself build
location /api-docs {
