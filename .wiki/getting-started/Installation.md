...
1. **[Follow the Quick Start Guide](Quick-Start.md)** - Get running in 5 minutes
2. **[Configure Your Environment](../configuration/README.md)** - Customize settings
3. **[Explore Commands](../COMMANDS.md)** - Learn all CLI commands
4. **[Set Up Services](../services/SERVICES.md)** - Enable additional features

---

**Need help?** Check the [Troubleshooting Guide](../guides/TROUBLESHOOTING.md) or [create an issue](https://github.com/acamarata/nself/issues).
