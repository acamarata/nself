...
print_framework_info() {
  ...
  type smart_timeout >/dev/null && printf "  ✓ Timeout Resilience\n"
  type is_docker_available >/dev/null && printf "  ✓ Docker Resilience\n"
  type check_network_available >/dev/null && printf "  ✓ Network Resilience\n"
  type assert_eventually >/dev/null && printf "  ✓ Flexible Assertions\n"
  printf "\n"
