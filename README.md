...
**v1.1.1 is out.** 6-bundle parity GA: ɳSentry (13 plugins), ClawDE buyable, Multi-Tenant Wall hardened. [Release notes](https://github.com/nself-org/cli/releases/tag/v1.1.1)
...
curl -fsSL https://github.com/nself-org/cli/releases/download/v1.1.1/checksums.txt

# Install with a pinned version and pinned SHA-256:
NSELF_VERSION=v1.1.1 \
...
**ɳSelf CLI v1.1.1** · [nself.org](https://nself.org) · [GitHub](https://github.com/nself-org/cli)
