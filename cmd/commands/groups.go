...
var commandGroupAssignments = map[string]string{
	...
	"migrate-from-v099": groupAdvanced,
	"release-check":     groupDeploy,
	"release-rollback":  groupDeploy,
	"release-status":    groupDeploy,
}
