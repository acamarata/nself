...
- [First Project](getting-started/FIRST-PROJECT.md) - Build your first app
- [Concepts](getting-started/CONCEPTS.md) - Core concepts explained
- [Demo Project](getting-started/DEMO.md) - Explore all features
...
- [Cascading Overrides](configuration/CASCADING-OVERRIDES.md)
...
- [Service Templates](reference/SERVICE-TEMPLATES.md)
...
- [Building a SaaS](tutorials/BUILDING-A-SAAS.md)
- [E-commerce Platform](tutorials/ECOMMERCE.md)
- [Mobile Backend](tutorials/MOBILE-BACKEND.md)
- [Realtime Chat](tutorials/REALTIME-CHAT.md)
...
3. [First Project](getting-started/FIRST-PROJECT.md) - 30 minutes
4. [Concepts](getting-started/CONCEPTS.md) - 20 minutes
...
4. [Authentication Guide](guides/AUTHENTICATION.md) - 30 minutes
