# nself cli v0.4.2 - Service & Monitoring Management
...
- [EMAIL.md](docs/commands/EMAIL.md)
- [SEARCH.md](docs/commands/SEARCH.md)
- [FUNCTIONS.md](docs/commands/FUNCTIONS.md)
- [MLFLOW.md](docs/commands/MLFLOW.md)
- [METRICS.md](docs/commands/METRICS.md)
- [MONITOR.md](docs/commands/MONITOR.md)
