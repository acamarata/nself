...
### [v0.4.1](v0.4.1.md) - Current Stable
...
- All 36 commands working on macOS, Linux, and WSL
...
#### v0.4.2 (Q1 2026)
- **Basic Tests**: Add tests for start/stop commands
- **Telemetry Infrastructure**: Opt-out analytics
- **Documentation Updates**: Improved guides

#### v0.4.3 (Q2 2026)
- **Deploy Command Improvements**: Enhanced SSH deployment
- **Database Operations**: Migration management
- **Backup Enhancements**: More restore options
...
|---------|------|--------|------------|
| [v0.4.1](v0.4.1.md) | Jan 2026 | **Current** | Platform compatibility fixes |
...
**Last Updated:** January 2026 | **Current Version:** v0.4.1
