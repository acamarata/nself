...
- **[Development Setup](contributing/DEVELOPMENT.md)** - Environment setup and coding standards
- **[Cross-Platform Compatibility](contributing/CROSS-PLATFORM-COMPATIBILITY.md)** - **CRITICAL** - Bash 3.2+, POSIX compliance rules
...
**Read [CROSS-PLATFORM-COMPATIBILITY.md](contributing/CROSS-PLATFORM-COMPATIBILITY.md) for complete rules.**
...
We are committed to providing a welcoming and inclusive environment. Please read our [Code of Conduct](contributing/CODE-OF-CONDUCT.md).
