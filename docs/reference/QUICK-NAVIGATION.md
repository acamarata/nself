...
| Task | Go to |
|------|-------|
| Install nself | [Installation Guide](../guides/Installation.md) |
| Get running in 5 minutes | [Quick Start](../guides/Quick-Start.md) |
...
| White-label branding | [Examples](../examples/README.md#whitelabel-config-example) |
...
| Database examples | [Database Examples](../examples/DATABASE-EXAMPLES.md) |
...
2. **Check the FAQ** - [FAQ](../guides/FAQ.md)
